...
function QuestionBuilder() {
    ...
    const { questionByIdDetails, loading: questionByIdDetailsLoading } = useSelector(
        (state) => state.getQuestionDetailsByid
    );
    ...
    useEffect(() => {
        if (updateQuestionResponse === null || updateQuestionResponse === undefined) return;
        ...
        if (isJSONString(questionByIdDetails.data)) {
            ...
            const answers = data.Answers.map((answer) => {
                return {
                    ...
                    consequence: {
                        value: answer.Content == null ? "Dummy consequence" : answer.Content, // TODO:: the consequence is null from backedn for now 
                        error: "",
                    },
                    narrative: {
    ...
    const onSubmit = async (event) => {
        ...
        if (!scenarioID && !questionID && questionData?.narrativeMedia?.value === "") {
                        ...
                        <div className={styles.questionContainer}>
                            ...
                            <div className={styles.questionInputContainer}>
                                ...
                                <div className={styles.questionInputRight}>
                                    ...
                                    {/* Decisin Maker :: start */}
                                    <div>
                                        <label htmlFor="dropdown_decision_maker" className="select_label">
                                            Decision Maker
                                        </label>
                                        <select
                                    ...
                                    <div className={styles.fileDropZone}>
                                        <FileDropZone
                                            ...
                                            fileSrcType={supportFileDisplayURL && extractFileType(supportFileDisplayURL)}
                                            setUrl={(file) => {
                                                setSupportFileDisplayURL(file);
                                            }}
                                        />
                                        ...
                                        <div key={index} className={styles.answerInputFields}>
                                            ...
                                            <div>
                                                <div>
                                                    <select
                                                        ...
                                                        className="select_input"
                                                        name={`optimal-${index}`}
                                                        onChange={(e) => onAnswerChange(e, index, 'optimal')}
                                                    >
                                            ...
                                            <div>
                                                <div>
                                                    <Input
                                                        ...
                                                        onChange={(e) => onAnswerChange(e, index, 'nextQuestion')}
                                            ...
                                            <div>
                                                <Input
                                                    ...
                                                    onChange={(e) => onAnswerChange(e, index, 'consequence')}
