...
const UpdateScenarios = () => {
    ...
    const { scenarioByIdDetails, loading: scenarioByIdDetailsLoading } = useSelector(
        (state) => state.getScenarioById
    );
    ...
    useEffect(() => {
        if (updateScenarioResponse === null || updateScenarioResponse === undefined) return;
    ...
    useEffect(() => {
        if (scenarioByIdDetails === null || scenarioByIdDetails === undefined) return;
