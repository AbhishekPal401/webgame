    ...
    <div className={styles.tabs}>
      ...
      >
        ...
        <div
          style={{
            backgroundColor:
              activeTab === "Optimal" ? "var(--primary)" : "var(--input_label)",
          }}
        ></div>
      </div>
    </div>
...
const ViewInstances = () => {
  ...
  const { getOverviewGameByIdDetails } = useSelector(
    (state) => state.getOverviewGameDetails
  );
                          ...
                          <div className={styles.treeRightTop}>
                            ...
                            <div>
                              ...
                              <div>
                                -{" "}
                                {data.TimeSpend &&
                                  convertSecondsToHMS(data.TimeSpend)}
                              </div>
                            </div>
                            <div>
